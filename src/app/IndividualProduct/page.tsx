...
const IndividualProduct = () => {
  ...
  // Fetch product data from products store
  useEffect(() => {
    if (productId) {
  ...
  useEffect(() => {
    if (productData) {
      // Add the product to recently viewed list
      addToRecentlyViewed({
        id: productData.id.toString(), // Convert id to string
        name: productData.title, // Use 'title' from your product structure
        price: parseFloat(productData.price), // Convert price string to number
