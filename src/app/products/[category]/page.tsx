    ...
    return (
      <div className="min-h-screen bg-gray-50 pt-24 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">No products found for category "{categoryName}".</p>
          <Link 
            href="/products"
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8 gap-4">
          <div>
            <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-2 capitalize">
              {categoryName} {selectedSubcategory !== 'all' && `- ${selectedSubcategory}`}
            </h1>
            <p className="text-gray-600 text-lg">
              Discover our premium {categoryName} collection
            </p>
              ...
              {filteredProducts.map((product, index) => (
                ...
                >
                  ...
                  <div className={`${viewMode === 'list' ? 'flex-1' : 'p-4'}`}>
                    <h3 className={`font-semibold text-gray-900 group-hover:text-[#7A1315] transition-colors mb-2 ${
